...
export default function FloatingActions() {
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4 items-end group">
            ...
            <button
                onClick={scrollToTop}
                className={`w-12 h-12 bg-gray-800 text-white rounded-full flex items-center justify-center shadow-lg transition-all duration-300 hover:bg-brand-yellow hover:text-black hover:-translate-y-1 focus:outline-none cursor-pointer ${showBackToTop
