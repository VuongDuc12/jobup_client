...
export default function OurJourneySection({
    ...
    const images = [
        { src: getAssetUrl(image1) || defaultImages[0].src, alt: defaultImages[0].alt, offset: false },
        { src: getAssetUrl(image2) || defaultImages[1].src, alt: defaultImages[1].alt, offset: true },
        { src: getAssetUrl(image3) || defaultImages[2].src, alt: defaultImages[2].alt, offset: false },
        { src: getAssetUrl(image4) || defaultImages[3].src, alt: defaultImages[3].alt, offset: true },
    ];
