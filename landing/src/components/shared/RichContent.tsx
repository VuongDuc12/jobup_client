...
const baseRichContentClassName = [
  ...
  "[&_[data-inline-icon]]:mx-1 [&_[data-inline-icon]]:inline-flex [&_[data-inline-icon]]:size-9 [&_[data-inline-icon]]:align-middle [&_[data-inline-icon]]:items-center [&_[data-inline-icon]]:justify-center [&_[data-inline-icon]]:rounded-full",
