...
export default function MobileMenu({
  ...
  return (
    <div
      className={`fixed inset-0 z-[100] bg-white transform transition-transform duration-500 lg:hidden flex flex-col ${
          ...
          return (
            <Link
              ...
              className={`flex items-center justify-between transition-colors ${
                isActive ? "text-brand-yellow" : "hover:text-brand-yellow"
              }`}
            >
              {link.label}
