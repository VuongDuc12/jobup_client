...
export const metadata: Metadata = {
  ...
  description:
    "Khám phá 100+ tin tuyển dụng việc làm mới nhất từ các tập đoàn hàng đầu. Lọc theo ngành nghề, mức lương và địa điểm. Tìm việc nhanh chóng cùng JobUp.",
  keywords:
  ...
  openGraph: {
    ...
    description:
      "100+ tin tuyển dụng đã xác thực. Tìm việc phù hợp nhất với bạn.",
